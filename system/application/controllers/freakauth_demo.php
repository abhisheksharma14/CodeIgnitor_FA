...
class Freakauth_demo extends Controller {
	...
	function index()
	{		
		$data['heading'] = 'UrbanWand';
        
        $data['message']='<div class="well col-md-6" style="margin-left:20%;"><h1>Welcome to UrbanWand</h1>';
		...
		$data['message'].="<br /><span class=\"important\">For frontend login you must register as user ".anchor($this->config->item('FAL_register_uri'), 'here')."</span></div>";
