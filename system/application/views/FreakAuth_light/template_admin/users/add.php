<h2 style="margin-left:20px;"><?=$action?></h2>
<div class="well col-md-4" style="margin-left:30%; margin-right:20%;">
...
<legend>User main</legend>
   ...
   <input type="reset" name="Reset" value="reset" class="btn btn-warning" style="margin-left:20px;" />
   <input type="submit" name="Submit" value="Add" class="btn btn-primary" style="margin-left:120px;" />
