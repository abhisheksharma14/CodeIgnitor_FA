...
<link rel='stylesheet' type='text/css' media='all' href='<?=base_url().$this->config->item('FAL_assets_admin').'/'.$this->config->item('FAL_css');?>/bootstrap.min.css' />
<!-- <link rel='stylesheet' type='text/css' media='all' href='<?=base_url().$this->config->item('FAL_assets_admin').'/'.$this->config->item('FAL_css');?>/admin_console.css' />
 --><link rel='stylesheet' type='text/css' media='all' href='<?=base_url().$this->config->item('FAL_assets_admin').'/'.$this->config->item('FAL_css');?>/style.css' />
<script src="<?=base_url().$this->config->item('FAL_assets_shared').'/'.$this->config->item('FAL_js');?>/jquery.js" type="text/javascript"></script>
<script src="<?=base_url().$this->config->item('FAL_assets_shared').'/'.$this->config->item('FAL_js');?>/bootstrap.min.js" type="text/javascript"></script>
