 ...
 */
 ...
 |
 */
 $config['FAL_user_support'] = 'localhost@localhost.com';
...
$config['FAL_captcha_image_font_color'] = '334455';
...
$config['FAL_admin_console_records_per_page'] = 6;
...
$config['FAL_user_profile_fields_validation_rules'] =
    array('name' => 'trim|required',
          'mobile' => 'trim|required|max_length[50]',
